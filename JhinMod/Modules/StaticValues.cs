...
namespace JhinMod.Modules
{
    internal static class StaticValues
    {
        ...
        /// <summary>
        /// The percent of missing health Whisper's execute uses as bonus damage
        /// </summary>
        internal const float executePrimaryMissingHealthDamagePercent = 0.3f;

        /// <summary>
        /// The maximum percentage of our damage that Execute skills can add as additional damage.
        /// </summary>
        internal const float executePrimaryDamagePercentCap = 1f;

        /// <summary>
        /// Percent conversion of Missing Health to Bonus Damage Jhin's special skill uses
        /// </summary>
        internal const float executeSpecialMissingHealthPercentToDamagePercent = 3f;
    }
}