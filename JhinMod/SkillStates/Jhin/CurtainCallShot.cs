...
namespace JhinMod.SkillStates
{
    public class CurtainCallShoot : BaseSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            Util.PlaySound("JhinUltLoadShot", base.gameObject);
        ...
        private void Fire()
        {
            if (!this.hasFired)
            {
                ...
                Util.PlaySound("JhinUltFire", base.gameObject);
                ...
                if (base.isAuthority)
                {
                    ...
                    new BulletAttack
                    {
                        ...
                        damage = CurtainCallShoot.damageCoefficient * this.damageStat,
                        damageColorIndex = DamageColorIndex.Default,
                        damageType = DamageType.Generic,
                        falloffModel = BulletAttack.FalloffModel.DefaultBullet,
                        maxDistance = CurtainCallShoot.range,
                        ...
                        weapon = null,
                        tracerEffectPrefab = CurtainCallShoot.tracerEffectPrefab,
                        spreadPitchScale = 0f,
                        spreadYawScale = 0f,
