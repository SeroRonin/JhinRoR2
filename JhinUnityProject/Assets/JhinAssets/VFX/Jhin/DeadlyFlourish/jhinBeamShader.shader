// Upgrade NOTE: upgraded instancing buffer 'jhinBeamShader' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "jhinBeamShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(jhinBeamShader)
			UNITY_DEFINE_INSTANCED_PROP(float4, _InnerColor)
#define _InnerColor_arr jhinBeamShader
			UNITY_DEFINE_INSTANCED_PROP(float4, _OuterColor)
#define _OuterColor_arr jhinBeamShader
		UNITY_INSTANCING_BUFFER_END(jhinBeamShader)
		...
		{
			Gradient gradient15 = NewGradient( 0, 2, 2, float4( 1, 1, 1, 0.4529488 ), float4( 0, 0, 0, 0.682353 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV12 = dot( ase_worldNormal, i.viewDir );
			float fresnelNode12 = ( 0.0 + 5.0 * pow( 1.0 - fresnelNdotV12, 1.0 ) );
			float grayscale19 = Luminance(SampleGradient( gradient15, fresnelNode12 ).rgb);
			Gradient gradient9 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4 ), float4( 0.424833, 0.424833, 0.424833, 0.7499962 ), float4( 1, 1, 1, 0.8500038 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
			float fresnelNdotV2 = dot( ase_worldNormal, i.viewDir );
			float fresnelNode2 = ( 0.0 + 5.0 * pow( 1.0 - fresnelNdotV2, 5.0 ) );
			float grayscale11 = Luminance(SampleGradient( gradient9, fresnelNode2 ).rgb);
			float4 _InnerColor_Instance = UNITY_ACCESS_INSTANCED_PROP(_InnerColor_arr, _InnerColor);
			float4 _OuterColor_Instance = UNITY_ACCESS_INSTANCED_PROP(_OuterColor_arr, _OuterColor);
			float layeredBlendVar4 = grayscale11;
			float4 layeredBlend4 = ( lerp( _InnerColor_Instance,_OuterColor_Instance , layeredBlendVar4 ) );
			float4 color18 = IsGammaSpace() ? float4(1,0.904378,0.5330188,0) : float4(1,0.7961036,0.2458856,0);
			float layeredBlendVar17 = grayscale19;
			float4 layeredBlend17 = ( lerp( layeredBlend4,color18 , layeredBlendVar17 ) );
			o.Emission = layeredBlend17.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
481;73;1463;756;192.0339;-494.4557;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;7;-635.2355,135.4422;Inherit;False;InstancedProperty;_OuterColor;Outer Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6792453,0,0.2597204,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;683.1634,572.9672;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;jhinBeamShader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=EC9EC11F6724F02D2D241879DE130011316B2530