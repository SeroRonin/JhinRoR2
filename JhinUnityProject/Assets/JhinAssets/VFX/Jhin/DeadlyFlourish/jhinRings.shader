// Upgrade NOTE: upgraded instancing buffer 'SeroRoninVFXjhinRings' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "SeroRonin/VFX/jhinRings"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(SeroRoninVFXjhinRings)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color0)
#define _Color0_arr SeroRoninVFXjhinRings
			UNITY_DEFINE_INSTANCED_PROP(float, _TexRGBWeight)
#define _TexRGBWeight_arr SeroRoninVFXjhinRings
		UNITY_INSTANCING_BUFFER_END(SeroRoninVFXjhinRings)
...
/*ASEBEGIN
Version=18935
481;73;1463;769;1345.299;329.0441;1;True;True
...
ASEEND*/
//CHKSM=740EB685B3D5CE300EF59C2A78C4F2D9AFF61339